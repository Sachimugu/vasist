  ...
  return (
    <div className="md:relative bg-sky-200 bg-bg-image md:">
      <div class="bg-sky-200 bg-opacity-30  w-[100%] md:w-[60%] lg:py-8">
        <div className=" sm:mt-0 max-w-[100rem] bg-gradient-to-b from-slate-950 via-slate-800 to-slate-950 flex mr-auto md:py-0 lg:py-8 items-center rounded-r-full text-white -300 justify-center border-r-[10px]  border-orange-400 ">
