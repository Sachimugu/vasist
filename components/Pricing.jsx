...
const PricingSwitch = ({ onSwitch }) => (
  <Tabs defaultValue="0" className="w-40 mx-auto bg-sky-500" onValueChange={onSwitch}>
...
const PricingCard = ({ isYearly, title, monthlyPrice, yearlyPrice, description, features, actionLabel, popular, exclusive }) => (
  <Card
    className={cn(` w-[80%] md:w-72 flex flex-col justify-between py-1 ${popular ? "border-rose-400" : "border-zinc-700"} mx-auto sm:mx-0`, {
...
const CheckItem = ({ text }) => (
  <div className="flex gap-2">
    <CheckCircle2 size={18} className="my-auto text-orange-500" />
