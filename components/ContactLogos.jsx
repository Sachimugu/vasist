...
const ContactLogos = () => {
  return (
    ...
    <div className='flex gap-8 md:gap-16 justify-center item-center px-4 py-2 md:p-8 bg-sky-200 shadow-md '>
        ...
        <Image src='/images/gm.svg' width={90} height={90} alt='icons' />
        <Image src='/images/wh.svg' width={100} height={100} alt='icons' />
        <Image src='/images/te.svg' width={100} height={100} alt='icons' />
        <Image src='/images/li.svg' width={100} height={100} alt='icons' />
    </div>
    </div>
  )
}
