    ...
    <div className="lg:min-h-screen min-h-screen pb-5 bg-slate-900">
      <div className="max-w-[100rem] mx-auto p-2 md:p-16">
        <div className="mt-36 sm:mt-0">
          <p className="text-3xl md:text-6xl font-extrabold text-center p-4 md:px-16 md:py-6 text-white">
          ...
          <p className="text-sm md:text-2xl  text-center p-4 leading-6 md:px-16 text-white">
            In the world where real income is fast shrinking, <span className="text-sky-500 text-sm md:text-2xl leading-6">creating multiple
            streams of incomes</span> becomes imperative. There are remote online data
          ...
          <div className="md:-ml-16  mt-6 md:mt-6 sm:mt-6 flex justify-center space-x-6 text-sm">
            <button
              type="button"
